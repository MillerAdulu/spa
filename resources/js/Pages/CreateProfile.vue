    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <form @submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <breeze-input id="mobile_phone_number" type="text" :value="$page.props.auth.user.mobile_phone_number" class="mt-1 block w-full" disabled="true" name="form.mobile_phone_number" required autofocus autocomplete="mobile_phone_number" />
            </div>
            ...
            <div class="mt-4">
                ...
                <breeze-input id="state" type="text" class="mt-1 block w-full" v-model="form.state" required autocomplete="state" />
            </div>
            ...
            <div class="mt-4">
                ...
                <breeze-input id="signature" type="file" accept="image/*,.pdf" class="mt-1 block w-full" name="form.signature" @change="selectSignature" required />
            ...
            <div class="mt-4">
                ...
                <breeze-input id="photograph" type="file" accept="image/*,.pdf" class="mt-1 block w-full" name="form.photograph" @change="selectPhotograph" required />
                <progress v-if="form.progress" :value="form.progress.percentage" max="100">
                    {{ form.progress.percentage }}%
                </progress>
            </div> 
            ...
            <div class="mt-4">
                ...
                <breeze-input id="means_of_identification" type="file" accept="image/*,.pdf" class="mt-1 block w-full" name="form.means_of_identification" @change="selectId" required />
                <progress v-if="form.progress" :value="form.progress.percentage" max="100">
                    {{ form.progress.percentage }}%
                </progress>
            </div> 
            ...
            <div class="mt-4">
                ...
                <breeze-input id="public_utility_bill" type="file" accept="image/*,.pdf" class="mt-1 block w-full" name="form.public_utility_bill" @change="selectUtilitybill" required />
                <progress v-if="form.progress" :value="form.progress.percentage" max="100">
                    {{ form.progress.percentage }}%
                </progress>
            </div>
